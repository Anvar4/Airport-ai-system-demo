        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-6">
          {stats.map((stat, i) => (
            <motion.div
              ...
              className="group relative p-6 sm:p-8 rounded-2xl bg-gradient-to-br from-dark-50 to-white dark:from-dark-800 dark:to-dark-800/50 border border-dark-100 dark:border-dark-700 hover:border-primary-200 dark:hover:border-primary-500/30 transition-all duration-300 card-hover text-center"
            >
